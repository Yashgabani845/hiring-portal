...
export default function ContributorPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let allContributors = [];
                const contributorsResponse = await fetch("https://api.github.com/repos/Yashgabani845/hiring-portal/contributors?page=1&per_page=100", {})
        ...
        <>
            ...
            <div className={`page-container ${mode === 'dark' ? 'dark-mode' : 'light-mode'}`}>
                ...
                <section className={`hero-section ${mode === 'dark' ? 'dark-mode' : 'light-mode'}`}>
                    <div style={{ textAlign: 'end', width: '100%', zIndex: '9' }}>
