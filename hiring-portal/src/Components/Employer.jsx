...
const Employer = () => {
  ...
  return (
    <div className="employer">
        ...
        <div className="main-content">
          <center>
            <div className="slogan">
              ...
              <p>
                Empowering employers with cutting-edge tools for efficient
                hiring.
              </p>
            </div>
          </center>
          <center>
            ...
            <button className="regcom" onClick={handlePostJob}>
              {buttonText}
            </button>
          </center>
        </div>
      ...
      <section className="quality-job-management" data-aos="fade-left">
        ...
        <div className="bottom-div">
          ...
          <div className="qright-div">
            <div className="quality-grid">
              <div className="quality-item" data-aos="zoom-in">
      ...
      <section className="shortlisting" data-aos="fade-right">
      ...
      <section className="whats-new" data-aos="fade-up">
        <center>
          <h2>What's New</h2>
        </center>
